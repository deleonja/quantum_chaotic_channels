...
\end{equation}
\subsection{Mean level spacing ratio}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{xxz/closed_L_10_Delta_0_5.pdf}
\caption{}
%\label{fig:choi:purity}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{choi/purity_dynamics/purity_dynamics.pdf}
...
\janote{esta es una especie de echo de Loschmidt!!! Cálculos en el 
apéndice \ref{app:choi}}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{choi_purity_spin_chain_vs_goe.pdf}
