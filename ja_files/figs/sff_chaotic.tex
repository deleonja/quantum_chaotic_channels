...
\begin{tikzpicture}
\node[anchor=north west] at (0,0) {\includegraphics[width=\tmpa cm]{sff_chaotic_all_spectrum.pdf}};
\node[anchor=north west] at (\separation*\tmpa, 0)
{\includegraphics[width=\tmpa cm]{sff_chaotic_even_parity_spectrum.pdf}};
